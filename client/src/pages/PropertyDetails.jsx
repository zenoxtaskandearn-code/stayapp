                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {property.payment_methods.map((method) => (
                      <div key={method.id} className="bg-primary/5 border border-primary/20 px-4 py-3 rounded-xl flex items-center gap-3 min-w-0">
                        <FiCreditCard className="text-primary flex-shrink-0" size={20} />
